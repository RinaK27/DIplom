...
class ChangeOfApplicationFromOpenToWorkInProgress {
    ...
    @Test
    fun changeOfApplicationFromOpenToWorkInProgress() {
        Thread.sleep(5000)
        ...
        val textView = onView(
            allOf(withId(android.R.id.title), withText("take to work"), isDisplayed())
        )
        textView.check(matches(withText("take to work")))
    }
