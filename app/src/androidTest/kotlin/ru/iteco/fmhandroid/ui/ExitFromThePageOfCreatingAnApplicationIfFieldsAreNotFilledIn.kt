...
class ExitFromThePageOfCreatingAnApplicationIfFieldsAreNotFilledIn {
    ...
    @Test
    fun exitFromThePageOfCreatingAnApplicationIfFieldsAreNotFilledIn() {
        Thread.sleep(5000)
        ...
        val viewGroup = onView(
            allOf(withId(R.id.claim_list_swipe_refresh), isDisplayed())
        )
