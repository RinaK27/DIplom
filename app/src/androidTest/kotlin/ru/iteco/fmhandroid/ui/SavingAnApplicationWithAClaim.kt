...
class SavingAnApplicationWithAClaim {
    ...
    @Test
    fun savingAnApplicationWithAClaim() {
        Thread.sleep(5000)
        ...
        textInputEditText3.perform(replaceText("Aftest1213"), closeSoftKeyboard())
        ...
        textInputEditText6.perform(replaceText("123test"), closeSoftKeyboard())
